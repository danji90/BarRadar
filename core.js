...
function createList(lat,lng){
    call_url = "https://api.foursquare.com/v2/venues/search?ll=" + lat + "," + lng + "&categoryId=4bf58dd8d48988d1e5931735&radius=1000&client_id=" + client_id + "&client_secret=" + client_secret + "&v=" + getCurrentDateString();
